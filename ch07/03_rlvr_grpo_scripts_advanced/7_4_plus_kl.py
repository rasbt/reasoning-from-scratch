...
def compute_grpo_loss(
    ...
    roll_logps, roll_ref_logps, roll_rewards, roll_entropies, samples = [], [], [], [], []
...
def append_step_metrics(
    ...
    if not CSV_LOG_PATH.exists():
        CSV_LOG_PATH.write_text(
            "step,total_steps,loss,kl_loss,policy_ratio,reward_avg,tokens_per_sec,avg_response_len,adv_avg,advantage_std,entropy_avg,eval_acc\n",
            encoding="utf-8",
        )
